...
wp core install --url="http://nsouchal.42.fr" --title="A beautiful website" --admin_user="nsouchal" --admin_password="${ADMIN_PASSWORD}" --admin_email="admin@example.com" --path='/var/www/wordpress' --allow-root
